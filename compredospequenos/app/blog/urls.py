...
from app.blog.views.blog.article_views import (
    ArticleListView,
    ArticleDetailView,
...
from app.blog.views.blog.category_views import (
...
from app.blog.views.blog.author_views import (
    AuthorArticlesListView,
    AuthorsListView,
)

from app.blog.views.blog.comment_views import (
    CommentCreateView,
    ArticleCommentList
)

from app.blog.views.dashboard.author.dashboard_views import (
    DashboardHomeView,
    ArticleWriteView,
    ArticleUpdateView,
    ArticleDeleteView,
...
from app.blog.views.dashboard.author.author_profile_views import (
    AuthorProfileUpdateView,
    AuthorProfileView,
)

from app.blog.views.account.register_view import \
    (
      ActivateView,
      AccountActivationSentView,
      UserRegisterView,
    )
from app.blog.views.account.logout_view import UserLogoutView
from app.blog.views.account.login_view import UserLoginView
