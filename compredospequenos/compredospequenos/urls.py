...
from homepage.views import SitemapXMLView, HomepageView
...
#      name='django.contrib.sitemaps.views.sitemap'),
    ...
    path('condominiosevizinhanca/', include('condominiosevizinhanca.urls', namespace='condominiosevizinhanca')),
    ...
    path('artigos/', include('blog.urls')),
    path('vamoresolve/', include('issueTracker.urls', namespace='ocorrencias')),
