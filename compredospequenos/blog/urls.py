...
from .views.blog.article_views import (
    ArticleListView,
    ArticleDetailView,
...
from .views.blog.category_views import (
...
from .views.blog.author_views import (
    AuthorArticlesListView,
    AuthorsListView,
)

from .views.blog.comment_views import (
    CommentCreateView,
    ArticleCommentList
)

from .views.dashboard.author.dashboard_views import (
    DashboardHomeView,
    ArticleWriteView,
    ArticleUpdateView,
    ArticleDeleteView,
...
from .views.dashboard.author.author_profile_views import (
    AuthorProfileUpdateView,
    AuthorProfileView,
)

from .views.account.register_view import \
    (
      ActivateView,
      AccountActivationSentView,
      UserRegisterView,
    )
from .views.account.logout_view import UserLogoutView
from .views.account.login_view import UserLoginView
