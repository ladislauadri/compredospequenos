    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtitle', models.CharField(blank=True, max_length=1500, null=True)),
                ('slug', models.SlugField(max_length=1500)),
                ('image', models.ImageField(default='article-default.jpg', upload_to='article_pics')),
                ('image_credit', models.CharField(blank=True, max_length=1000, null=True)),
        ...
        migrations.AddField(
            model_name='article',
            name='sites',
            field=models.ManyToManyField(related_name='articles', to='sites.Site'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
